...
chat_window.tag_configure("user_tag", foreground="white", background="#007AFF", justify="left", font=("Helvetica", 12, "bold"), relief=tk.RAISED, lmargin1=10, lmargin2=10, rmargin=10)
chat_window.tag_configure("bot_tag", foreground="white", background="#34C759", justify="right", font=("Helvetica", 12, "italic"), relief=tk.RAISED, lmargin1=10, lmargin2=10, rmargin=10)
...
send_button = tk.Button(input_frame, text="Send", command=send_message, font=("Helvetica", 12), bg="#007AFF", fg="white", width=8)
