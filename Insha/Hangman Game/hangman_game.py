...
# GUI Layout
word_label = tk.Label(root, textvariable=displayed_word, font=('Helvetica', 18))
word_label.pack(pady=20)

attempts_label = tk.Label(root, text="Attempts left: ")
attempts_label.pack()

attempts_left_label = tk.Label(root, textvariable=attempts_left, font=('Helvetica', 14))
attempts_left_label.pack()

incorrect_guesses_label = tk.Label(root, text="Incorrect guesses: ", font=('Helvetica', 12))
